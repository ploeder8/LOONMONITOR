// VAA bedrijfswagen — AJ 2027 / inkomstenjaar 2026.
// SSOT: knowledgebase/04_calculator_netto.md §5.7.
...
export function vaaBedrijfswagen(input: VaaBedrijfswagenInput): VaaBedrijfswagenResultaat {
  ...
  const berekendJaar = round2(
    cataloguswaarde * (co2Percentage / 100) * leeftijdsCoefficient * (6 / 7),
  );
...
function splitYearMonth(value: string): [number, number] {
