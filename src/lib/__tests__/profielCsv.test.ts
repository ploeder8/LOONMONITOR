...
import { bouwCsvExportRij, normaliseerCsvBestandsnaam, profielNaarCsv, profielUitCsv, profielenUitCsv, standaardCsvNaamPrefix, } from "@/lib/profielCsv";
describe("profielCsv", () => {
    ...
    it("normaliseert CSV-bestandsnamen", () => {
        ...
        expect(normaliseerCsvBestandsnaam("2026-05-20-test", "2026-05-20")).toBe("2026-05-20-test.csv");
        expect(normaliseerCsvBestandsnaam("2026-05-20-test.csv", "2026-05-20")).toBe("2026-05-20-test.csv");
        expect(normaliseerCsvBestandsnaam("   ", "2026-05-20")).toBe("2026-05-20-jaakie-export.csv");
    });
});
