...
export function ProfielEditorDrawer({ open, profiel, set, onClose, }: {
    open: boolean;
    profiel: Profiel;
    set: ProfielSetter;
    onClose: () => void;
    ...
    if (!open)
        return null;
    return (<div className="profiel-editor-drawer" style={{
            position: "fixed",
            inset: 0,
            zIndex: 210,
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <ProfielEditorHeader />
          <button type="button" onClick={onClose} aria-label="Profiel sluiten" style={{
            width: 34,
            height: 34,
