...
export function LoonfichePage() {
    ...
    return (<div style={{ maxWidth: 1280, margin: "0 auto", padding: "1.5rem 1rem" }}>
      ...
      <div className="loonfiche-acties" style={{
            display: "flex",
            justifyContent: "flex-end",
            gap: 8,
            marginBottom: 16,
        }}>
        <button type="button" onClick={() => setProfielEditorOpen(true)} style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 6,
            padding: "6px 12px",
      ...
      <ErrorBoundary fallbackRender={({ error, resetErrorBoundary }) => (<Banner kind="error" title="Onverwachte fout bij het opbouwen van de loonfiche">
