...
function AppShell() {
    ...
    return (<div className="min-h-screen" style={{ background: "var(--color-background)", color: "var(--color-text)" }}>
        <header style={{
          ...
          <div style={{
            ...
            <nav className="app-nav" style={{ display: "flex", gap: 4, flexWrap: "wrap", maxWidth: "100%" }}>
              ...
              <a href="/onderzoek/index.html" target="_blank" rel="noopener noreferrer" style={{
            padding: "8px 14px",
            fontSize: 13,
            fontWeight: 600,
...
function NavItem({ to, label }: {
    ...
    return (<NavLink className="app-nav-link" to={to} end style={({ isActive }) => ({
            padding: "8px 14px",
            fontSize: 13,
            fontWeight: 600,
