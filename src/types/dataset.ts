// Hand-written types matching pc200_payroll_dataset.schema.json (Draft-07).
// Kept in lockstep with the schema; runtime validation in src/lib/schemaValidate.ts
// is authoritative — these types are a TypeScript convenience.
