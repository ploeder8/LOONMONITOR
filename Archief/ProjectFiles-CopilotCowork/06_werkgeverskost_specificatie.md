...
| Voordeel | Werkgeverskost-typisch | Bron / wettelijk kader |
|----------|--------------------------|--------------------------|
| Groepsverzekering | 3–8% van brutoloon (werkgeverdeel) | WAP, ondernemingsspecifiek |
| Maaltijdcheques | €6,91/dag (max werkgeverdeel €6,91) | KB indexering 2026 |
| Hospitalisatieverzekering | €30–€90/m per persoon | sectorbreed |
| ECO-cheques | tot €250/jaar | cao 98 nationale arbeidsraad |
| Mobiliteitsvergoeding | tot €0,37/km × max 3.700 km/jaar | fiscaal vrijgesteld AJ 2027 |
| Bedrijfswagen | TCO autoleasing — verschilt sterk per model | apart luik |
| GSM/laptop/internet | €4–€20/m forfaitair | KB BV-tabellen |

Loonmotor accepteert deze als configureerbare extra inputs (bedrag/maand).
